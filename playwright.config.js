...
export default defineConfig({
  ...
  projects: [
    ...
    {
      name: 'stubbed',
      testMatch: /admin-(auth|editors|modals|funds|idle|txn)\.spec\.js/,
      use: {
    ...
    },
    {
      name: 'desktop',
      dependencies: ['setup'],
      testIgnore: /(admin-auth|admin-editors|admin-modals|admin-funds|admin-idle|admin-txn|status-page)\.spec\.js/,
